...
| 1.b  | Upload the `Seagrass_site_data.xlsx` to the `data` folder       | ![img_tutorial_06a-Upload_file.png](documentation/images/img_tutorial_06a-Upload_file.png "Upload") **==>** ![img_tutorial_06b-Upload_file.png](documentation/images/img_tutorial_06b-Upload_file.png "data folder") |
| 1.c  | Click `Git public` back to workspace   | ![img_tutorial_06c-Back_to_root.png](documentation/images/img_tutorial_06c-Back_to_root.png "Back") |
| 2    | Start workflow         | ![img_tutorial_01-Run_workflow.png](documentation/images/img_tutorial_01-Run_workflow.png "Start workflow") |
...
| 3.2  | Change file name       | The uploaded excel file name `Seagrass_site_data.xlsx` |
| 4    | Execute workflow       | ![img_tutorial_03-Exec_workflow.png](documentation/images/img_tutorial_03-Exec_workflow.png "Execute workflow") |
| 5    | Check the progress     | ![img_tutorial_04-Progress.png](documentation/images/img_tutorial_04-Progress.png "Check the progress") |
